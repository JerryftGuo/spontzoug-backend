...
import com.spontzoug.server.service.IResidentialStaffService;
...
@RestController
@RequestMapping("/api/residentialstaff")
public class ResidentialStaffController {
    @Autowired
    private IResidentialStaffService personalCareArtistService;
    @Autowired
    ...
    public void create(@RequestBody ResidentialStaff l) {  personalCareArtistService.create(l); }

    @PutMapping("/update")
    @ResponseStatus(HttpStatus.OK)
    public Mono<ResidentialStaff> update(@RequestBody ResidentialStaff m) {
    ...
    @GetMapping("/id/{id}")
    public ResponseEntity<Mono<ResidentialStaff>> findById(@PathVariable("id") String id) {
        Mono<ResidentialStaff> m = personalCareArtistService.findById(id);
        HttpStatus s = m!=null ? HttpStatus.OK : HttpStatus.NOT_FOUND;
        return new ResponseEntity<Mono<ResidentialStaff>>(m,s);
    }

    @GetMapping("/businessid/{id}")
    public Flux<ResidentialStaff> findByBusinessid(@PathVariable("id") String id){
        return personalCareArtistService.findByBusinessid(id);
    }
    @GetMapping("/businessconfig/{id}")
    public Flux<ResidentialStaff> findByBusinessConf(@PathVariable("id") String id){
        return personalCareArtistService.findByBusinessid(id);
    }
    @GetMapping("/businessid/{id}/{date}")
    public Flux<ResidentialStaff> findByBusinessidInc(
    ...
    public Flux<ResidentialStaff> findDynamics(@PathVariable("id") String id){
        return personalCareArtistService.findDynamics(id);
    }
    @GetMapping("/dynamic/{id}/{date}")
    public Flux<ResidentialStaff> findDynamicsInc(
            @PathVariable("id") String id,
            @PathVariable("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date date){
